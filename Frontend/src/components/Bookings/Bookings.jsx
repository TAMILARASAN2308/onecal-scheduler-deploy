...
function Bookings() {
  ...
  useEffect(() => {
    ...
    fetch(`https://onecal-scheduler-deploy.onrender.com/auth/bookings/${storedEmail}`)
  ...
  const handleCancelBooking = async (id) => {
    try {
      const response = await fetch(`https://onecal-scheduler-deploy.onrender.com/auth/cancel/${id}`, {
        method: 'PUT',

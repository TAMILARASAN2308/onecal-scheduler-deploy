...
function UpdateEvent() {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        const response = await fetch(`https://onecal-scheduler-deploy.onrender.com/auth/get-event/${id}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`https://onecal-scheduler-deploy.onrender.com/auth/update-event/${id}`, {
        method: "PUT",
